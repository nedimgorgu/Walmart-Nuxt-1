<template>
    ...
    <section class="h-custom h-100" style="background-color: #0071DC;">

        <div class="container py-5">

            <div class="col-3 m-auto"><img src="https://i5.walmartimages.com/dfw/63fd9f59-b3e1/7a569e53-f29a-4c3d-bfaf-6f7a158bfadd/v1/walmartLogo.svg" height="120px"/></div>
                                    ...
                                    <div class="p-5">
                                        ...
                                        <div class="row mb-4 d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="col-md-1 col-lg-1 col-xl-1 text-end">
                                                <a href="#!" class="text-muted"> <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></a>
                                            </div>
